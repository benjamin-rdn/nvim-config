...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      -- Bootstrap: install desired parsers (no-op if already installed, async)
      ...
      -- Unlike the old module-based config, features must be enabled explicitly.
      vim.api.nvim_create_autocmd('FileType', {
        ...
        callback = function(args)
          ...
          -- Enable treesitter syntax highlighting (replaces vim regex syntax).
          ...
          -- Enable treesitter-based indentation (experimental, skip Ruby)
          if ft ~= 'ruby' then
